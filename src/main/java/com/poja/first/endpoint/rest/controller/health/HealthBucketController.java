...
import static com.poja.first.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import com.poja.first.PojaGenerated;
import com.poja.first.file.bucket.BucketComponent;
import com.poja.first.file.hash.FileHash;
import java.io.File;
